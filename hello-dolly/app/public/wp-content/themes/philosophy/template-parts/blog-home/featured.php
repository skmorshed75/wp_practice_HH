            ...
            <div class="featured__column featured__column--big">
                <div class="entry" style="background-image:url('<?php echo esc_url($post_data[0]['thumbnail']); ?>)">
                    ...
                    <div class="entry__content">
                        ...
                        <h1><a href="<?php echo esc_url($post_data[0]['permalink']); ?>" title="<?php echo esc_html($post_data[0]['title']); ?>"></a>
                        </h1>

                        <div class="entry__info">
                            <a href="<?php echo esc_url($post_data[0]['permalink']); ?>" class="entry__profile-pic">
                                <img class="avatar" src="<?php echo esc_url($post_data[0]['author_avatar']); ?>" alt="<?php echo esc_url($post_data[0]['author']); ?>">
                            </a>

                            <ul class="entry__meta">
                                <li><a class="bypostauthor" href="<?php echo esc_url($post_data[0]['permalink']); ?>"><?php echo esc_html($post_data[0]['author']); ?></a></li>
