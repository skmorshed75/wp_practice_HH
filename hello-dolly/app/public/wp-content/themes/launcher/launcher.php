<?php
/**
 * Template Name: Launcher Homepage99
 */
?>
<?php
the_post();
...
<div id="fh5co-main-content">
    ...
    <div id="fh5co-footer">
        <div class="row">
            <div class="col-md-6">
                <?php
                if(is_active_sidebar("launcher-footer-left")){
                    dynamic_sidebar("launcher-footer-left");
                }
                ?>
            </div>            
            <div class="col-md-6 fh5co-copyright">
                <?php
                if(is_active_sidebar("launcher-footer-right")){
                    dynamic_sidebar("launcher-footer-right");
                }
                ?>
            </div>
        </div>
